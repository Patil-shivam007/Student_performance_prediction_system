  ...
  return (
    <div className="teacher-dashboard">
      <div className="teacher-dashboard-header">
        <div>
          <h1>
            Welcome, {dashboard.teacher.first_name || dashboard.teacher.username} 👋
          </h1>
      ...
      <div className="teacher-stats">
        ...
        <div className="teacher-stat-card">
          ...
          <div>
            <span>Subjects</span>
            <strong>{dashboard.summary.total_subjects}</strong>
          </div>
        </div>
      ...
      <section className="teacher-dashboard-card teacher-students-card">
        ...
        {studentsLoading ? (
          ...
          <div className="teacher-error">{studentsError}</div>
        ) : students.length === 0 ? (
          <div className="no-students">
            <h3>No students found</h3>
            <p>There are currently no students in the Student group.</p>
          </div>
        ) : (
